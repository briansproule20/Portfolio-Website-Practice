...
const photos: Photo[] = [
  ...
  },
  {
    ...
    title: "Mum and Dad",
    category: "Family",
    description: "A poor man's portrait of my parents... date unknown.",
    image: "/photos/mumanddad.JPG",
    width: 3024,
    height: 4032,
  },
  {
    id: 20,
    title: "The Buffet Boys",
    category: "Friends",
    description: "The Central Catholic Penn State boys out in Columbus for some football",
    image: "/photos/simonnolan.JPG",
    width: 3024,
    height: 4032,
  },
  {
    ...
    title: "España",
    category: "Friends",
    description: "Best group of friends anyone could hope for in Spain.",
    image: "/photos/espana.JPG",
    width: 3024,
    height: 4032,
  },
  {
    ...
    category: "Friends",
    description: "Sam and Em showing me around Lexington, Kentucky during a visit to the University of Kentucky.",
    image: "/photos/UK.JPG",
    width: 3024,
    height: 4032,
  },
  {
    ...
    title: "Sammy",
    category: "Family",
    description: "Sammy and I enjoying some tapas y tinto en Seville.",
    image: "/photos/sammy.JPG",
    width: 3024,
    height: 4032,
  },
  {
    ...
    title: "Chicago",
    category: "Friends",
    description: "Visiting Brad out in Chicago with the rest of the AKPsi family.",
    image: "/photos/Chi.JPG",
    width: 3024,
    height: 4032,
  },
  {
    ...
    title: "Mum in Spain",
    category: "Family",
    description: "Mum flew to Spain to visit while I studied abroad in Seville.",
    image: "/photos/MumSpain.JPG",
    width: 3024,
    height: 4032,
  },
  {
    ...
    title: "In the Shoe",
    category: "Friends",
    description: "Early morning Block to the Shoe for the OSU Game.",
    image: "/photos/OSUGame.JPG",
    width: 3024,
    height: 4032,
  },
  {
...
export function getFeaturedPhotos(): Photo[] {
  // Get 4 random photos for consistent layout
  const shuffledPhotos = [...photos].sort(() => Math.random() - 0.5);
  return shuffledPhotos.slice(0, 4);
}
